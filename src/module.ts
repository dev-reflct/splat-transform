...
export const processGaussianSplat = async (
    ...
    await writeSogs(outputFileHandle, processedData, 'output.meta.json', iterations, gpuMode);
    console.log(`💾 Output written with ${iterations} iterations using ${gpuMode} mode`);
